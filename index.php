            ...
            <div class="donation-content-panel">
                ...
                <div class="donate-form-text-monthly">
                    <div class="donate-form-text 10-monthly active" id="10">
                        <p>Monthly - Could provide an art set for an ex-child soldier like Peter to develop his
                            passion and
                            skill
                            for
                            painting.</p>
                    ...
                    <div class="donate-form-text 15-monthly" id="15">
                        <p>Monthly - Could provide an early years book for a child like Faisal attending pre-school
                            in a
                            refugee
                            camp.</p>
                    </div> <!-- End of 15 -->
                    <div class="donate-form-text 30-monthly" id="30">
                        <p>Monthly - Could provide antibiotics to help a baby like Lawrence with severe acute
                            malnutrition
                            back to
                            health.</p>
                    </div> <!-- End of 30 -->
                ...
                <div class="donate-form-text-single">
                    <div class="donate-form-text 25-single" id="25">
                        <p>Single - Could give a bright child like Harriet essential schoolbooks and stationary when
                            she
                            returns
                            to
                            school. </p>
                    ...
                    <div class="donate-form-text 50-single" id="50">
                        <p>Single - Could give a baby with malnutrition like Lawrence a month of highly nutritious
                            food to
                            help
                            them
                            recover. </p>
                    ...
                    <div class="donate-form-text 100-single" id="100">
                        <p>Single - Could buy interactive games for refugee children like Faisal and his friends to
                            play and
                            learn
                            together. </p>
                    </div> <!-- End of 100-->
...
<div class="header-text-component bottom-spacer">
    ...
    <div class="text-wrapper">
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vestibulum justo sit amet tellus finibus
            iaculis. Sed libero nulla, feugiat in molestie ac, venenatis tempus magna. Quisque consectetur tortor
            sem,
            eu sagittis massa maximus id. Curabitur mollis cursus leo non pellentesque. Nam venenatis, ipsum at
            egestas
            pellentesque, velit nisl suscipit lacus, ac elementum sem purus eget quam. Integer venenatis feugiat
            ante at
            ...
            taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse viverra
            finibus
            odio.</p>
    ...
    <div class="left-right-container">
        ...
        <div class="text-container">
            ...
            <p>Existuje mnoho podôb pasáží Lorem Ipsum, ale väčšina trpela rôznymi zmenami, vložením humoru, alebo
                náhodných slov, ktoré nevyzerajú ani trocha dôveryhodne. Ak sa chystáte použiť pasáž z Lorem Ipsum,
                mali
                by ste sa presvedčiť, že uprostred textu nie je skrytá žiadna časť, ktorá by vás mohla priviesť do
                nepríjemnej situácie. Všetky generátory Lorem Ipsum na internete opakujú vopred definované časti
                textu,
                takže náš generátor je prvým skutočným generátorom na internete. Používa slovník viac ako 200
                latinských
                slov, a kombinuje ich niekoľkými modelovými vetnými štruktúrami, takže generuje Lorem Ipsum, ktoré
                vyzerá hodnoverne. Vygenerované Lorem Ipsum je týmto spôsobom vždy bez opakujúcich sa častí, bez
                vtipov
...
<div class="left-right-component right bottom-spacer">
    <div class="left-right-container">
        ...
        <div class="text-container">
            <h2>Our Impact</h2>
            <p>Napriek všeobecnému presvedčeniu nie je Lorem Ipsum len náhodný text. Jeho korene sú v časti
                klasickej
                ...
                consectetur, z pasáže Lorem Ipsum, a ako vyhľadával výskyt tohto slova v klasickej literatúre,
                objavil
    ...
    <div class="row-container row-container--vertical">
        ...
        <div class="card-wrapper">
            <div class="card card-two clickable card--vertical">
                ...
                <div class="card-text-container">
                    <a href="/learning/tutorial-two.php" aria-label="Fundraising in Celebration">Fundraising in
                        Celebration</a>
        ...
        <div class="card-wrapper">
            <div class="card card-three clickable card--vertical">
                ...
                <div class="card-text-container">
                    <a href="/learning/tutorial-three.php" aria-label="Donate To Specific Project">Donate To
                        Specific Project</a>
