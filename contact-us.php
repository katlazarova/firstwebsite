...
<h1 class="bottom-spacer">Contact Us</h1>
<h2>FAQ</h2>
<div class="accordion-component bottom-spacer">
    <button class="accordion">My Account<span style="font-size: $font-small; color: $secondary-color;">
					<i class="fas fa-plus"></i>
				</span><span style="font-size: $font-small; color: $secondary-color;">
    ...
    <button class="accordion">Donating<span style="font-size: $font-small; color: $secondary-color;">
        <i class="fas fa-plus"></i>
        </span><span style="font-size: $font-small; color: $secondary-color;">
        <i class="fas fa-minus"></i>
        </span></button>
    ...
    <button class="accordion">Contacting the Media Team<span style="font-size: $font-small; color: $secondary-color;">
        <i class="fas fa-plus"></i>
        </span><span style="font-size: $font-small; color: $secondary-color;">
        <i class="fas fa-minus"></i>
        </span></button>
    ...
    <button class="accordion">Complaints<span style="font-size: $font-small; color: $secondary-color;">
        <i class="fas fa-plus"></i>
        </span><span style="font-size: $font-small; color: $secondary-color;">
        <i class="fas fa-minus"></i>
        </span></button>
